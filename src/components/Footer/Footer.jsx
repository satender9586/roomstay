...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-slate-900 to-slate-700 py-12">
      ...
      <footer className="px-4 divide-y dark:bg-gray-100 dark:text-gray-800 text-white">
          ...
          <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-1 text-[12px] font-sans">
                <li>sksatender59@gmail.com</li>
                <li>jai.singh.corporate@gmail.com</li>
        ...
        {/* <div className=" flex  gap-3 text-xs md:text-sm lg:text-lg xl:text-sm">
          <div className="leading-6">Satender - sksatender59@gmail.com</div>
          <div className="leading-6">
            Jai Singh - jai.singh.corporate@gmail.com
          </div>
          <div className="leading-6">
            Suraj - suraj.kumar.corporate@gmail.com
          </div>
        </div> */}
