...
const RoomCard = ({ obj }) => {
  const { description, price, roomNumber, amenities, _id } = obj

  const router = useRouter()
  return (
    <div className=" flex justify-center  ">
      <div className=" flex justify-center gap-10 border shadow-lg rounded-lg mt-2 p-4 ">
        <div className="">
          <Image
            src={HotelRoom}
            alt="image"
        ...
        <div className="flex flex-col gap-2">
          <div className="text-[30px] font-bold">Flagship white Diamond</div>
