              ...
              <div className="grid grid-cols-5 gap-5 mt-3">
                ...
                <div className="col-span-3">
                  ...
                  <h1 className="mt-[0.2rem]">
                    Rating <span>3.5</span> very good
                  </h1>
                  ...
                  <div className=" flex justify-between mt-[1rem]">
                    <div>
                      <h1 className="flex items-center gap-1 md:text-[1.5rem] ">
                        450{" "}
                        <span
                    ...
                    <div className="flex items-center justify-center px-10 gap-3">
                      <button
                        className="p-[0.7rem] px-[1rem]  bg-white  text-md text-black "
                        style={{ border: "1px solid #E9E9E9" }}
                      >
                        view Details
                      </button>
                      <button className="p-[0.7rem] px-[1rem]  bg-green-500  text-md text-white ">
                        Book Now
                      </button>
                    </div>
                  </div>
